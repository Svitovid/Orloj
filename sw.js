/* Orloj Personal v29 — network first, offline fallback */
var CACHE = "orloj-personal-v29";
  ...
  event.respondWith(
    fetch(event.request)
      .then(function(response){
        ...
        caches.open(CACHE).then(function(cache){ try { cache.put(event.request, copy); } catch(e) {} });
        return response;
      })
      .catch(function(){
